...
<head>
    <meta charset="UTF-8">
    <title>Responsive Design: Mobile First - Sprint 2 Challenge</title>
...
<body>
    ...
    <section class="artists-container">
        <div class="artist">
            <img class="center" src="https://images.fineartamerica.com/images/artworkimages/mediumlarge/3/starry-night-by-vincent-van-gogh-vincent-van-gogh.jpg"/>
           <a class="name" href="https://en.wikipedia.org/wiki/Vincent_van_Gogh"> Vincent Van Gogh</a>
        ...
        <div class="artist">
            <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg/600px-The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg"/>
            <a class="name" href="https://en.wikipedia.org/wiki/J._M._W._Turner"> Joseph Mallord William Turner</a>
